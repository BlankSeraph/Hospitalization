				...
				<div class="log">
					<form id="loginform" name="loginform" method="post">
						...
						<div class="chc" id="yzm">
							<label>验证码</label><input type="text" class="chctext"
								placeholder="验证码" name="Verification" id="Verification"
								onblur="cleanYerror();"> <img src="image.do"
								id="yzmimage" align="middle" onclick="this.src=this.src+'?'" />
						</div>
						...
						<div>
							<input type="button" id="login" class="submit" value="登录"
								onclick="Login();">
						</div>
					</form>
				</div>
